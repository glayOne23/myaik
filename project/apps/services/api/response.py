...
class CustomPagination(LimitOffsetPagination):
    ...
    def get_next_link(self):
        ...
        hostname_override = getattr(settings, 'HOSTNAME_OVERRIDE', None)
        if next_link and hostname_override:
            parsed_url = urlparse(next_link)
            modified_url = parsed_url._replace(netloc=hostname_override)
    ...
    def get_previous_link(self):
        ...
        hostname_override = getattr(settings, 'HOSTNAME_OVERRIDE', None)
        if previous_link and hostname_override:
